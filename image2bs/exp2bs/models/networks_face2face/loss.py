...
from models.networks_face2face.architecture import VGG19, VGGFace19
...
class IDLoss(nn.Module):
    def __init__(self, opt):
        ...
        self.opt = opt
        self.facenet = IRSE_Backbone(input_size=112, num_layers=50, drop_ratio=0.6, mode='ir_se')
        # self.load_pretrain()
    ...
    def load_pretrain(self, ckpt_path=None):
        ...
        self.facenet.load_state_dict(check_point)
