...
python3 train.py \
  --dataset_mode exp2bs \
  --exp_basis_folder /home/zechen/Deep3DFaceRecon_pytorch/checkpoints/facerecon/results/M111_combined_cam_front/epoch_20_000000 \
  --blendshape_file /home/zechen/Deep3DFaceRecon_pytorch/datasets/M111_combined_blendshape.json \
  --model exp2bs \
  --netV exp2bs \
  --netE fc50blendshape \
  --netG modulate \
  --checkpoints_dir checkpoint/EXP2BS \
  ...
  --display_port 8900 \
  --display_ncols 2 \
  --display_env Exp2BlendshapeRegress \
  --name Exp2BlendshapeRegress \
  --batchSize 64 \
  --lr 3e-4 \
  --n_epochs 2 \
  --n_epochs_decay 8 \
