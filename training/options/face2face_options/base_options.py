...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--model', type=str, default='face2face', help='which model to use, rotate|rotatespade')
        ...
        # for setting inputsf
        parser.add_argument('--dataset_mode', type=str, default='vox')
        ...
        parser.add_argument('--style_dim', type=int, default=2560, help='# of encoder filters in the first conv layer')
